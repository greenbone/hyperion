...
class OverrideTestCase(SeleneTestCase):
    ...
    def test_create_override(self, mock_gmp: GmpMockFactory):
        mock_gmp.mock_response(
            'create_override',
            '''
            <create_override_response status="201" status_text="OK,
        ...
        override_id = json['data']['createOverride']['id']
        self.assertEqual(override_id, 'e1438fb2-ab2c-4f4a-ad6b-de97005256e8')

        mock_gmp.gmp_protocol.create_override.assert_called_with(
            "Test Override",
    ...
    def test_create_override_minimal(self, mock_gmp: GmpMockFactory):
        mock_gmp.mock_response(
            'create_override',
            '''
            <create_override_response status="201" status_text="OK,
