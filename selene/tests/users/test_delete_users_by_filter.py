...
class DeleteUsersByFilterTestCase(SeleneTestCase):
    def setUp(self):
        self.id1 = uuid4()
        self.id2 = uuid4()
    ...
    def test_delete_users_by_filter(self, mock_gmp: GmpMockFactory):
