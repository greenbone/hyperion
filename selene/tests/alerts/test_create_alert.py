...
class CreateAlertTestCase(SeleneTestCase):
    def setUp(self):
        self.alert_id = uuid4()
        self.xml = f'''
    ...
    def test_create_alert(self, mock_gmp: GmpMockFactory):
        ...
        uuid = json['data']['createAlert']['id']

        self.assertEqual(uuid, str(self.alert_id))
    ...
    def test_create_alert_method_scp(self, mock_gmp: GmpMockFactory):
        mock_gmp.mock_response(self.cmd, self.xml)
    ...
    def test_create_alert_method_send(self, mock_gmp: GmpMockFactory):
        mock_gmp.mock_response(self.cmd, self.xml)
    ...
    def test_create_alert_method_smb(self, mock_gmp: GmpMockFactory):
        mock_gmp.mock_response(self.cmd, self.xml)
    ...
    def test_create_alert_method_snmp(self, mock_gmp: GmpMockFactory):
        mock_gmp.mock_response(self.cmd, self.xml)
    ...
    def test_create_alert_method_syslog(self, mock_gmp: GmpMockFactory):
        mock_gmp.mock_response(self.cmd, self.xml)
    ...
    def test_create_alert_method_start_task(self, mock_gmp: GmpMockFactory):
        mock_gmp.mock_response(self.cmd, self.xml)
    ...
    def test_create_alert_method_http_get(self, mock_gmp: GmpMockFactory):
        mock_gmp.mock_response(self.cmd, self.xml)
    ...
    def test_create_alert_method_sourcefire_connector(
    ...
    def test_create_alert_method_verinice_connector(
        self, mock_gmp: GmpMockFactory
    ):
        mock_gmp.mock_response(self.cmd, self.xml)
    ...
    def test_create_alert_method_email_notice_1(self, mock_gmp: GmpMockFactory):
        mock_gmp.mock_response(self.cmd, self.xml)
    ...
    def test_create_alert_method_alemba_vfire(self, mock_gmp: GmpMockFactory):
        mock_gmp.mock_response(self.cmd, self.xml)
    ...
    def test_create_alert_method_tp_sms(self, mock_gmp: GmpMockFactory):
        mock_gmp.mock_response(self.cmd, self.xml)
    ...
    def test_create_alert_method_email_notice_0(self, mock_gmp: GmpMockFactory):
        mock_gmp.mock_response(self.cmd, self.xml)
    ...
    def test_create_alert_method_email_notice_2(self, mock_gmp: GmpMockFactory):
        mock_gmp.mock_response(self.cmd, self.xml)
    ...
    def test_create_alert_condition_always(self, mock_gmp: GmpMockFactory):
        mock_gmp.mock_response(self.cmd, self.xml)
    ...
    def test_create_alert_condition_filter_count_at_least(
        self, mock_gmp: GmpMockFactory
    ):
        mock_gmp.mock_response(self.cmd, self.xml)
    ...
    def test_create_alert_condition_severity_changed(
        self, mock_gmp: GmpMockFactory
    ):
        mock_gmp.mock_response(self.cmd, self.xml)
    ...
    def test_create_alert_event_updated_secinfo(self, mock_gmp: GmpMockFactory):
        mock_gmp.mock_response(self.cmd, self.xml)
    ...
    def test_create_alert_event_new_secinfo(self, mock_gmp: GmpMockFactory):
        mock_gmp.mock_response(self.cmd, self.xml)
    ...
    def test_create_alert_event_task_status_changed(
        self, mock_gmp: GmpMockFactory
    ):
        mock_gmp.mock_response(self.cmd, self.xml)
    ...
    def test_create_alert_event_ticket_received(self, mock_gmp: GmpMockFactory):
        mock_gmp.mock_response(self.cmd, self.xml)
    ...
    def test_create_alert_event_owned_ticket_changed(
        self, mock_gmp: GmpMockFactory
    ):
        mock_gmp.mock_response(self.cmd, self.xml)
