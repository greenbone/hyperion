...
class ExportCertBundAdvisoriesByIdsTestCase(SeleneTestCase):
    def setUp(self):
        self.id1 = uuid4()
        self.id2 = uuid4()
    ...
    def test_export_cert_bund_advisories_by_ids(self, mock_gmp: GmpMockFactory):
        self.login('foo', 'bar')
    ...
    def test_export_cert_bund_advisories_empty_ids_array(
        ...
        mock_gmp.gmp_protocol.get_info_list.assert_called_with(
            filter_string='', details=True, info_type=GvmInfoType.CERT_BUND_ADV
        )
