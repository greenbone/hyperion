...
class ExportCpesByFilterTestCase(SeleneTestCase):
    def test_require_authentication(self, _mock_gmp: GmpMockFactory):
        response = self.query(
            '''
            mutation {
                exportCpesByFilter(filterString: "lorem=ipsum") {
                   exportedEntities
                }
            }
            '''
    ...
    def test_export_cpes_by_filter(self, mock_gmp: GmpMockFactory):
        self.login('foo', 'bar')
        ...
        xml = json['data']['exportCpesByFilter']['exportedEntities']
