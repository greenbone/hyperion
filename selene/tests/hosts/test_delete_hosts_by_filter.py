...
class DeleteAssetsByFilterTestCase(SeleneTestCase):
    def test_require_authentication(self, _mock_gmp: GmpMockFactory):
        response = self.query(
            '''
            mutation {
                deleteHostsByFilter(filterString: "name~Clone") {
                   ok
                }
            }
            '''
    ...
    def test_delete_filtered_hosts(self, mock_gmp: GmpMockFactory):
        self.login('foo', 'bar')
        ...
        ok = json['data']['deleteHostsByFilter']['ok']
