...
class ExportDfnCertAdvisoriesByFilterTestCase(SeleneTestCase):
    def test_require_authentication(self, _mock_gmp: GmpMockFactory):
        response = self.query(
            '''
            mutation {
                exportDfnCertAdvisoriesByFilter(filterString: "lorem=ipsum") {
                   exportedEntities
                }
            }
            '''
    ...
    def test_export_dfn_cert_advisories_by_filter(
        ...
        xml = json['data']['exportDfnCertAdvisoriesByFilter'][
            'exportedEntities'
        ]
