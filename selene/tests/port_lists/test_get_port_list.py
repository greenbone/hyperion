...
class PortListTestCase(SeleneTestCase):
    ...
    def test_get_port_list_no_port_ranges(self, mock_gmp: GmpMockFactory):
        mock_gmp.mock_response(
            'get_port_list',
            '''
            <get_port_lists_response>
        ...
        self.assertIsNone(port_list['portRanges'])
    ...
    def test_get_port_list_no_port_range(self, mock_gmp: GmpMockFactory):
        mock_gmp.mock_response(
            'get_port_list',
            '''
            <get_port_lists_response>
