...
class ExportPortListsByFilterTestCase(SeleneTestCase):
    def test_require_authentication(self, _mock_gmp: GmpMockFactory):
        response = self.query(
            '''
            mutation {
                exportPortListsByFilter(filterString: "lorem=ipsum") {
                   exportedEntities
                }
            }
            '''
    ...
    def test_export_port_lists_by_filter(self, mock_gmp: GmpMockFactory):
        ...
        xml = json['data']['exportPortListsByFilter']['exportedEntities']
