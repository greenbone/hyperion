...
class ModifyPolicySetNameTestCase(SeleneTestCase):
    def setUp(self):
        self.id1 = uuid4()
        self.name = 'some name'
    ...
    def test_modify_policy_set_name(self, mock_gmp: GmpMockFactory):
        ...
        ok = json['data']['modifyPolicySetName']['ok']
...
@patch('selene.views.Gmp', new_callable=GmpMockFactory)
class ModifyPolicySetCommentTestCase(SeleneTestCase):
    def setUp(self):
        self.id1 = uuid4()
    ...
    def test_modify_policy_set_comment(self, mock_gmp: GmpMockFactory):
        mock_gmp.mock_response(
        ...
        ok = json['data']['modifyPolicySetComment']['ok']
...
@patch('selene.views.Gmp', new_callable=GmpMockFactory)
class ModifyPolicySetFamilySelectionTestCase(SeleneTestCase):
    def setUp(self):
        self.id1 = uuid4()
    ...
    def test_modify_policy_set_family_selection(self, mock_gmp: GmpMockFactory):
        mock_gmp.mock_response(
        ...
        ok = json['data']['modifyPolicySetFamilySelection']['ok']

        self.assertEqual(ok, True)

        # pylint: disable=line-too-long
        mock_gmp.gmp_protocol.modify_policy_set_family_selection.assert_called_with(
            policy_id=str(self.id1),
...
@patch('selene.views.Gmp', new_callable=GmpMockFactory)
class ModifyPolicySetNvtPreferenceTestCase(SeleneTestCase):
    def setUp(self):
        self.id1 = uuid4()
    ...
    def test_modify_policy_set_nvt_prefernce(self, mock_gmp: GmpMockFactory):
        mock_gmp.mock_response(
        ...
        ok = json['data']['modifyPolicySetNvtPreference']['ok']

        self.assertEqual(ok, True)

        # pylint: disable=line-too-long
        mock_gmp.gmp_protocol.modify_policy_set_nvt_preference.assert_called_with(
            policy_id=str(self.id1),
            name=self.name,
...
@patch('selene.views.Gmp', new_callable=GmpMockFactory)
class ModifyPolicySetNvtSelectionTestCase(SeleneTestCase):
    def setUp(self):
        self.id1 = uuid4()
    ...
    def test_modify_policy_set_nvt_selection(self, mock_gmp: GmpMockFactory):
        mock_gmp.mock_response(
        ...
        ok = json['data']['modifyPolicySetNvtSelection']['ok']
...
@patch('selene.views.Gmp', new_callable=GmpMockFactory)
class ModifyPolicySetScannerPreferenceTestCase(SeleneTestCase):
    def setUp(self):
        self.id1 = uuid4()
    ...
    def test_modify_policy_set_scanner_prefernce(
        ...
        ok = json['data']['modifyPolicySetScannerPreference']['ok']
