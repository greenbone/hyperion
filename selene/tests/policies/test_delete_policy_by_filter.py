...
class DeletePoliciesByFilterTestCase(SeleneTestCase):
    def setUp(self):
        self.id1 = uuid4()
        self.id2 = uuid4()
        self.xml = f'''
    ...
    def test_delete_policies_by_filter(self, mock_gmp: GmpMockFactory):
        ...
        ok = json['data']['deletePoliciesByFilter']['ok']
        self.assertTrue(ok)
