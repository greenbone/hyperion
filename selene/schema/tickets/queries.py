...
class GetTicket(graphene.Field):
    """Gets a single ticket.

    Args:
        id (UUID): UUID of the ticket being queried
    ...
    Example:
        ...
        .. code-block::
            ...
            query {
                ticket (ticketId: "f5c40267-71ab-4cd7-b14b-3599a84522e8") {
                    name
                    comment
                }
            }
    ...
    def resolve(_root, info, ticket_id: UUID):
        gmp = get_gmp(info)

        xml = gmp.get_ticket(str(ticket_id))
        return xml.find('ticket')


class GetTickets(EntityConnectionField):
    """Gets a list of tickets with pagination
    ...
    Example:
        ...
        .. code-block::
            ...
            query {
                tickets (filterString: "name~TICKET rows=4") {
                    nodes {
                        id
                        name
                    }
    ...
    def resolve_entities(  # pylint: disable=arguments-differ
        ...
        requested = xml.find('tickets')

        return Entities(ticket_elements, counts, requested)
